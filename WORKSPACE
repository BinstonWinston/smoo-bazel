register_execution_platforms(
    ...
    # //:devkitpro_nx_toolchain (which is simple_cpp_toolchain).
    ...
    # //devkitpro_toolchain:simple_cpp_toolchain. This causes the first
    # execution platform to be rejected during execution platform selection.
    "@local_config_platform//:host",
    "//:devkitpro_nx_platform"
)

register_toolchains(
    "//:devkitpro_nx_toolchain"
)