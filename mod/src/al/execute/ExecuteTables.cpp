...
static constexpr al::ExecuteOrder drawTableArr[] = {
    ...
    {"FlagActor", "ActorModelDrawDeferred", 512, "ボス"},
    {"BorderActor", "ActorModelDrawDeferred", 512, "ボス"}
};
...
static constexpr al::ExecuteOrder updateTableArr[] = {
    ...
    {"FlagActor", "ActorMovementCalcAnim", 512, "ボス"},
    {"BorderActor", "ActorMovementCalcAnim", 512, "ボス"}
};
...
constexpr al::ExecuteTable drawTable[] = {
    ...
    createDrawTable("CTFFlagOnlineDrawExecutors", "FlagActor", "ActorModelDrawDeferred", "FlagActor", "ActorModelDrawDeferred"),
    createDrawTable("CTFBorderOnlineDrawExecutors", "BorderActor", "ActorModelDrawDeferred", "BorderActor", "ActorModelDrawDeferred"),
};
...
constexpr al::ExecuteTable updateTable[] = {
    ...
    createUpdateTable("CTFFlagOnlineUpdateExecutors", "FlagActor", "FlagActor"),
    createUpdateTable("CTFBorderOnlineUpdateExecutors", "BorderActor", "BorderActor"),
};
